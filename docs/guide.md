...
Usage guide for the skin tissue simulation. See also: [Architecture](architecture.md) | [Parameters](parameters.md) | [Validation](validation.md) | [Wound Healing](wound-healing.md) | [Tumor](tumor.md)
...
For the full metrics column reference, see [Validation: Metrics columns](validation.md#metrics-columns). For the validation framework and literature comparison scripts, see the [validation suite](../literature/README.md).

```bash
python3 literature/validate_all.py          # full dashboard with RMSE
python3 literature/validators/compare_wound.py         # 2x2 wound healing summary
python3 literature/validators/compare_fibroblast.py    # myofibroblast + collagen
python3 literature/validators/compare_tumor.py         # tumor growth + Ki-67
```
