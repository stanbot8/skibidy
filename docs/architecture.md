...
Technical architecture of Skibidy, a hybrid agent-continuum skin tissue simulation. See also: [Guide](guide.md) | [Parameters](parameters.md) | [Validation](validation.md) | [Wound Healing](wound-healing.md) | [Tumor](tumor.md)
